...
(assert-not
  ...
  (par (x)
    (forall ((y x) (z (list x)) (x2 Int))
      (= (<= (count y z) (+ x2 x2)) (<= (count y z) x2)))))
(assert-not
  :speculated-lemma
  (par (x)
    (forall ((y x) (z (list x)) (x2 Int))
      (= (<= (count y (cons y z)) x2) (<= 1 x2)))))
(assert-not
  :speculated-lemma
  (forall ((x Int))
...
(assert-not
  :speculated-lemma
  (forall ((x Int) (y (list Int)))
    (= (<= y (insert x (insert x y))) (<= y (insert x y)))))
(assert-not
  :speculated-lemma
  (forall ((x (list Int)) (y Int) (z Int))
    (= (<= (insert y x) (insert z x)) (<= y z))))
(assert-not
  :speculated-lemma
...
(assert-not
  ...
  (forall ((x (list Int)) (y (list Int)))
    (= (<= x (insert 0 (insert 1 y))) (<= x (insert 0 (insert 0 y))))))
(assert-not
  :speculated-lemma
  (forall ((x (list Int)))
...
(assert-not
  :speculated-lemma
  (forall ((x (list Int)))
    (= (<= (insert 0 (insert 1 x)) x) (<= (insert 0 x) x))))
(assert-not
  :speculated-lemma
  (forall ((x (list Int)))
...
(assert-not
  ...
  (forall ((x (list Int)) (y Int) (z Int) (x2 (list Int)))
    (= (<= x2 (insert y (cons z x))) (<= x2 (insert y (cons z x2))))))
(assert-not
  :speculated-lemma
  (forall ((x Int) (y Int) (z (list Int)))
    (= (<= (cons y (insert x z)) z) (<= (cons y z) z))))
(assert-not
  :speculated-lemma
  (forall ((x Int) (y (list Int)) (z Int) (x2 (list Int)))
    (= (<= (cons z (insert x y)) x2) (<= (cons z x2) x2))))
(assert-not
  :speculated-lemma
...
(assert-not
  :speculated-lemma
  (forall ((x (list Int)) (y (list Int)))
    (= (<= x (insert 1 (insert 1 y))) (<= x (insert 1 y)))))
(assert-not
  :speculated-lemma
  (par (x)
    (forall ((y x))
...
(assert-not
  :speculated-lemma
  (forall ((x Int) (y (list Int)) (z (list Int)))
    (= (<= (cons x (isort y)) (isort z)) (<= (cons x y) (isort z)))))
(assert-not
  :speculated-lemma
  (forall ((x Int) (y Int) (z (list Int)))
